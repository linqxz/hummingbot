...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ----------------- | ----------------------------------------------------- | -------------------------------------------------- |
| GET ACTIVE MARKETS                                                                                                                                                   | TRUE          | Public REST       | Endpoint to get list of active trading pairs. example | GET /markets                                       |
...
| [TR] MINIMUN NOTIONAL SIZE                                                                                                                                           | Conditionally | Public REST       | Endpoint to get trading rules. example                | GET /markets                                       |
| [TR] MINIMUN ORDER SIZE                                                                                                                                              | Conditionally | Public REST       | Endpoint to get trading rules. example                | GET /markets                                       |
| [TR] MINIMUN PRICE                                                                                                                                                   | Conditionally | Public REST       | Endpoint to get trading rules. example                | GET /markets                                       |
| [TR] ORDER INCREMENT                                                                                                                                                 | Conditionally | Public REST       | Endpoint to get trading rules. example                | GET /markets                                       |
| PING ENDPOINT                                                                                                                                                        | TRUE          | Public REST       | For low info endpoints, like ping. example            | GET /                                              |
| GET ACCOUNT BALANCE                                                                                                                                                  | TRUE          | Private REST      | Get current account balance. example                  | GET /wallet/balances                               |
...
| GET OPEN ORDERS                                                                                                                                                      | TRUE          | Private REST      | Get active orders. example                            | GET /orders                                        |
| CREATE ORDERS                                                                                                                                                        | TRUE          | Private REST      | Create new orders. example                            | POST /orders                                       |
| CREATE ORDERS with client order id                                                                                                                                   | Conditionally | Private REST      | Create new orders. example                            | POST /orders                                       |
...
| ORDERBOOK CHANNEL (Min depth 100)                                                                                                                                    | TRUE          | Public Websocket  | Public orders channel. example                        | orderbook                                          |
| ORDERBOOK DIFF CHANNEL                                                                                                                                               | Conditionally | Public Websocket  | Public orders channel. example                        | orderbook                                          |
| USER TRADES CHANNEL (Order Status, fills, fees)                                                                                                                      | TRUE          | Private Websocket | Private orders updates. example                       | fills                                              |
| USER ORDER CHANNEL (Order Status, fills, fees)                                                                                                                       |               | Private Websocket |                                                       | orders                                             |
| USER BALANCE CHANNEL (total and available)                                                                                                                           | FALSE         | Private Websocket | Private balance events. example                       |                                                    |
| AUTHENTICATION                                                                                                                                                       | TRUE          | Other             | Auth logic for web assistant. example                 |                                                    |
| Rate limits                                                                                                                                                          | TRUE          | Other             | Rate limits documentation. example                    |                                                    |
...
## Web Utils
* connector_name_web_utils.py file
...
## Utils
* Code in connector_name_utils.py file
